...
<div class="footer">
  <div class="content">
    ...
    <div class="right_footer"><!--правая часть футера-->
      <ul class="footer_menu"><!--Разные блоки с будущим меню-->
        <li>
...
1)width=100%/n
2)margin-left-right=(width_site-(with_block*n))/n/2
3)margin-left-right=(100/2n)-width_block/2
4)margin-left-right=(width_site-width_block*n)/(n-1)/2
-->
